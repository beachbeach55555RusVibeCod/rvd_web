        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              и нефтесервисного оборудования в Казани, Альметьевске и по всей
            ...
            <ul className="space-y-2">
              {[
                ...
                "Ремонт и замена рукавов на месте",
                "Подбор фитингов и переходников",
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { num: "500+", text: "постоянных клиентов" },
