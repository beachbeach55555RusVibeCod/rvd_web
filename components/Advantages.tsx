const items = [
  { icon: "⚡", title: "Быстро", desc: "Изготовление РВД от 1 часа. Срочные заказы — приоритет." },
  { icon: "🚗", title: "Выезд к клиенту", desc: "Приедем и заменим рукав прямо на вашей технике или производстве." },
  { icon: "📐", title: "Любая конфигурация", desc: "Прямые, угловые 45° и 90°, нестандартная длина, любые типы фитингов." },
  { icon: "🛡️", title: "Гарантия", desc: "Гарантия на все изделия. Работаем только с сертифицированными материалами." },
  { icon: "📦", title: "Свой склад", desc: "Широкий ассортимент рукавов и фитингов в наличии в обоих городах." },
